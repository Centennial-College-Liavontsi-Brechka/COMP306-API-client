package net.liavontsibrechka.invoker;
...
import net.liavontsibrechka.invoker.auth.Authentication;
import net.liavontsibrechka.invoker.auth.HttpBasicAuth;
import net.liavontsibrechka.invoker.auth.ApiKeyAuth;
import net.liavontsibrechka.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2017-12-27T18:03:09.518-05:00")
@Component("net.liavontsibrechka.invoker.ApiClient")
public class ApiClient {
    ...
    private String basePath = "https://api-final-project-19022.appspot.com";
